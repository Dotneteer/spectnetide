...
{
    [ComVisible(true)]
    public class RomEditorPane: WindowPane, IOleComponent, IVsDeferredDocView, IVsLinkedUndoClient, IVsPersistDocData, IPersistFileFormat
    {
        ...
        public RomEditorControl RomEditorControl { get; private set; }
        ...
        /// </summary>
        public string FileExtensionUsed => RomEditorFactory.EXTENSION;

        /// <summary>Initializes a new instance of the <see cref="T:System.Object" /> class.</summary>
        public RomEditorPane()
        {
        ...
        protected override void Initialize()
        {
            ...
            Content = RomEditorControl = new RomEditorControl();
        ...
        {
            pGuidCmdId = typeof(RomEditorFactory).GUID;
            return VSConstants.S_OK;
        }
        ...
        {
            pClassId = typeof(RomEditorFactory).GUID;
            return VSConstants.S_OK;
        }
