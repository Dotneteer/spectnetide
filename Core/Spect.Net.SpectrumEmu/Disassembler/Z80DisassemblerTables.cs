    ...
    public partial class Z80Disassembler
    {
        ...
        private static readonly InstructionTable s_ExtendedInstructions = new InstructionTable(
            new List<OperationMapBase>
            {
                ...
                new SingleOperationMap(0x25, "ld hl,sp", true),
                ...
                new SingleOperationMap(0x34, null),
                new SingleOperationMap(0x35, null),
                new SingleOperationMap(0x36, null),
                new SingleOperationMap(0x37, "inc dehl", true),
                new SingleOperationMap(0x38, "dec dehl", true),
                new SingleOperationMap(0x39, "add dehl,a", true),
                new SingleOperationMap(0x3A, "add dehl,bc", true),
                new SingleOperationMap(0x3B, "add dehl,^W", true),
                new SingleOperationMap(0x3C, "sub dehl,a", true),
                new SingleOperationMap(0x3D, "sub dehl,bc", true),
                ...
                new SingleOperationMap(0x8B, "popx", true),
                ...
                new SingleOperationMap(0x90, null),
                new SingleOperationMap(0x91, "nextreg ^B,^B", true),
                new SingleOperationMap(0x92, "nextreg ^B,a", true),
                new SingleOperationMap(0x93, null),
                new SingleOperationMap(0x94, null),
                new SingleOperationMap(0x95, null),
