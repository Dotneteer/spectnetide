...
public partial class CommandToolParser : Parser {
	...
	public const int
		...
		RULE_compactCommand = 26, RULE_exportCommand = 27;
	...
	public partial class ToolCommandContext : ParserRuleContext {
		...
		public ExportCommandContext exportCommand() {
			return GetRuleContext<ExportCommandContext>(0);
		}
	...
	public partial class ExportCommandContext : ParserRuleContext {
		public ITerminalNode X() { return GetToken(CommandToolParser.X, 0); }
		public ITerminalNode[] LITERAL() { return GetTokens(CommandToolParser.LITERAL); }
		public ITerminalNode LITERAL(int i) {
			return GetToken(CommandToolParser.LITERAL, i);
		}
		...
		public ExportCommandContext(ParserRuleContext parent, int invokingState)
			: base(parent, invokingState)
		{
		}
		public override int RuleIndex { get { return RULE_exportCommand; } }
		public override void EnterRule(IParseTreeListener listener) {
			ICommandToolListener typedListener = listener as ICommandToolListener;
			if (typedListener != null) typedListener.EnterExportCommand(this);
		}
		public override void ExitRule(IParseTreeListener listener) {
			ICommandToolListener typedListener = listener as ICommandToolListener;
			if (typedListener != null) typedListener.ExitExportCommand(this);
		}
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ICommandToolVisitor<TResult> typedVisitor = visitor as ICommandToolVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitExportCommand(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	[RuleVersion(0)]
	public ExportCommandContext exportCommand() {
		ExportCommandContext _localctx = new ExportCommandContext(_ctx, State);
		EnterRule(_localctx, 54, RULE_exportCommand);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public static readonly string _serializedATN =
		...
		"\a\'\x2\x2\x10A\x10C\a\x3\x2\x2\x10B\x10A\x3\x2\x2\x2\x10B\x10C\x3\x2"+
		"\x2\x2\x10C\x10D\x3\x2\x2\x2\x10D\x10E\a,\x2\x2\x10E\x10F\a\x3\x2\x2\x10F"+
