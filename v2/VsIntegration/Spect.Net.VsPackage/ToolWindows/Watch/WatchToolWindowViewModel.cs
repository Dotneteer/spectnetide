...
namespace Spect.Net.VsPackage.ToolWindows.Watch
{
    ...
    public class WatchToolWindowViewModel : BankAwareToolWindowViewModelBase
    {
        ...
        /// </summary>
        public SymbolAwareSpectrumEvaluationContext EvalContext { get; set; }
        ...
        public bool ProcessCommandline(string commandText, out string validationMessage)
        {
            ...
            switch (command)
            {
                case AddWatchToolCommand addWatchCommand:
                    ...
                    RefreshWatchItems();
                    if (EmulatorViewModel.MachineState == VmState.Paused
                        || EmulatorViewModel.MachineState == VmState.Running)
                    {
                        EvaluateWatchItems();
                    }
                    break;
