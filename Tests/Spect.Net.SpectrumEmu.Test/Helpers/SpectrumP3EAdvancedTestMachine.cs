...
namespace Spect.Net.SpectrumEmu.Test.Helpers
{
    public class SpectrumP3EAdvancedTestMachine: Spectrum48
    {
        ...
        /// </summary>
        public SpectrumP3EAdvancedTestMachine(): 
            base(new DeviceInfoCollection
            {
                new CpuDeviceInfo(SpectrumModels.ZxSpectrumP3EPal.Cpu),
                ...
                new ScreenDeviceInfo(SpectrumModels.ZxSpectrumP3EPal.Screen, 
                    new TestPixelRenderer(SpectrumModels.ZxSpectrumP3EPal.Screen)),
