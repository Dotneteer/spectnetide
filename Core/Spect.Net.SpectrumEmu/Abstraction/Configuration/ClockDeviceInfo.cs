...
namespace Spect.Net.SpectrumEmu.Abstraction.Configuration
{
    ...
    /// </summary>
    public sealed class ClockDeviceInfo: DeviceInfoBase<IClockDevice, IClockConfiguration, IClockProvider>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:System.Object" /> class.
        /// </summary>
        /// <param name="provider">Optional provider instance</param>
        public ClockDeviceInfo(IClockProvider provider) : base(null, provider)
        {
        }
    }
}