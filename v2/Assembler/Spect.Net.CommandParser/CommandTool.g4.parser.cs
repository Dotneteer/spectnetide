...
{
    public partial class CommandToolParser
    {
        /// <summary>
        /// Syntax errors caught during the parsing phase
        /// </summary>
        public List<CommandToolParserErrorInfo> SyntaxErrors { get; } = new List<CommandToolParserErrorInfo>();
        ...
        private class Z80TestErrorListener : IAntlrErrorListener<IToken>
        {
            ...
            /// </summary>
            private CommandToolParser Parser { get; }

            /// <summary>Initializes a new instance of the <see cref="T:System.Object" /> class.</summary>
            public Z80TestErrorListener(CommandToolParser parser)
            {
                Parser = parser;
            }
            ...
            {
                Parser.SyntaxErrors.Add(new CommandToolParserErrorInfo()
                {
