...
{
    /// <summary>
    /// This class represents an UNARY ANY operation
    /// </summary>
    public sealed class UnaryAnyNode: UnaryExpressionNode
    {
        /// <summary>
        ...
        public override ExpressionValue Evaluate(IExpressionEvaluationContext evalContext, bool checkOnly = false)
        {
            ...
            return operandValue.Type != ExpressionValueType.ByteArray 
                ...
                : new ExpressionValue(operandValue.AsByteArray().Any(item => item != 0));
        }

        public UnaryAnyNode(ParserRuleContext context) : base(context)
        {
        }
    }
}