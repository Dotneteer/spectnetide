...
namespace Spect.Net.Z80Emu.Core
{
    ...
    public partial class Z80
    {
        ...
        /// </summary>
        private static readonly byte[] s_IncOpFlags =
        {
        ...
        /// </summary>
        private static readonly byte[] s_DecOpFlags =
        {
        ...
        /// </summary>
        private static readonly ushort[] s_DAAResults =
        {
            ...
            0x0044, 0x0100, 0x0200, 0x0304, 0x0400, 0x0504, 0x0604, 0x0700,
            0x0808, 0x090C, 0x1011, 0x1115, 0x1215, 0x1311, 0x1415, 0x1511,
            0x1000, 0x1104, 0x1204, 0x1300, 0x1404, 0x1500, 0x1600, 0x1704,
            0x180C, 0x1908, 0x2031, 0x2135, 0x2235, 0x2331, 0x2435, 0x2531,
            0x2020, 0x2124, 0x2224, 0x2320, 0x2424, 0x2520, 0x2620, 0x2724,
            0x282C, 0x2928, 0x3035, 0x3131, 0x3231, 0x3335, 0x3431, 0x3535,
            0x3024, 0x3120, 0x3220, 0x3324, 0x3420, 0x3524, 0x3624, 0x3720,
            0x3828, 0x392C, 0x4011, 0x4115, 0x4215, 0x4311, 0x4415, 0x4511,
            0x4000, 0x4104, 0x4204, 0x4300, 0x4404, 0x4500, 0x4600, 0x4704,
            0x480C, 0x4908, 0x5015, 0x5111, 0x5211, 0x5315, 0x5411, 0x5515,
            0x5004, 0x5100, 0x5200, 0x5304, 0x5400, 0x5504, 0x5604, 0x5700,
            0x5808, 0x590C, 0x6035, 0x6131, 0x6231, 0x6335, 0x6431, 0x6535,
            ...
            0x4002, 0x4106, 0x4206, 0x4302, 0x4406, 0x4502, 0x4602, 0x4706,
            0x480E, 0x490A, 0x4407, 0x4503, 0x4603, 0x4707, 0x480F, 0x490B,
            0x5006, 0x5102, 0x5202, 0x5306, 0x5402, 0x5506, 0x5606, 0x5702,
            0x580A, 0x590E, 0x5403, 0x5507, 0x5607, 0x5703, 0x580B, 0x590F,
            0x6026, 0x6122, 0x6222, 0x6326, 0x6422, 0x6526, 0x6626, 0x6722,
            0x682A, 0x692E, 0x6423, 0x6527, 0x6627, 0x6723, 0x682B, 0x692F,
            0x7022, 0x7126, 0x7226, 0x7322, 0x7426, 0x7522, 0x7622, 0x7726,
            0x782E, 0x792A, 0x7427, 0x7523, 0x7623, 0x7727, 0x782F, 0x792B,
            0x8082, 0x8186, 0x8286, 0x8382, 0x8486, 0x8582, 0x8682, 0x8786,
            0x888E, 0x898A, 0x8487, 0x8583, 0x8683, 0x8787, 0x888F, 0x898B,
            0x9086, 0x9182, 0x9282, 0x9386, 0x9482, 0x9586, 0x9686, 0x9782,
            0x988A, 0x998E, 0x9483, 0x9587, 0x9687, 0x9783, 0x988B, 0x998F,
