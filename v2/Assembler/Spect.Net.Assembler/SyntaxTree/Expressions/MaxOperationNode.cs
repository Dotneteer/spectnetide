...
namespace Spect.Net.Assembler.SyntaxTree.Expressions
{
    ...
    /// </summary>
    public sealed class MaxOperationNode : BinaryOperationNode
    {
        private const string LEFT_STRING_ERROR = "The left operand of 'max' cannot be a string";
        private const string RIGHT_STRING_ERROR = "The right operand of 'max' cannot be a string";
