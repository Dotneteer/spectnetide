            ...
            switch (left.Type)
            {
                ...
                case ExpressionValueType.Integer:
                    ...
                    switch (right.Type)
                    {
                        ...
                        case ExpressionValueType.String:
                            EvaluationError = "Cannot use bitwise AND between an integer number and a string";
                ...
                case ExpressionValueType.Real:
                    ...
                    switch (right.Type)
                    {
                        ...
                        case ExpressionValueType.String:
                            EvaluationError = "Cannot use bitwise AND between a real number and a string";
                            return ExpressionValue.Error;
                        default:
                            return ExpressionValue.Error;
                    }
                ...
                case ExpressionValueType.String:
                    EvaluationError = "The left operand of bitwise AND cannot be a string";
                    return ExpressionValue.Error;
