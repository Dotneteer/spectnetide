...
namespace Spect.Net.Assembler.SyntaxTree.Expressions
{
    ...
    {
        private const string LEFT_STRING_ERROR = "The left operand of division cannot be a string";
        private const string RIGHT_STRING_ERROR = "The right operand of division cannot be a string";
