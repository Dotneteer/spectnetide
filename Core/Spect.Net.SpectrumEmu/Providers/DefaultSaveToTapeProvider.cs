...
{
    public class DefaultSaveToTapeProvider: VmComponentProviderBase, ISaveToTapeProvider
    {
        ...
        public DefaultSaveToTapeProvider(string folder = null)
        {
            SaveFileFolder = string.IsNullOrWhiteSpace(folder) 
