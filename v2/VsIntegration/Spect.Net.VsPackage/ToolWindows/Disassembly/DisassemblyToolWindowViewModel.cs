...
namespace Spect.Net.VsPackage.ToolWindows.Disassembly
{
    public class DisassemblyToolWindowViewModel : BankAwareToolWindowViewModelBase, IDisassemblyItemParent
    {
            ...
            out string newPrompt)
        {
            ...
            newPrompt = null;
            ushort? address = null;
            var breakPoints = SpectrumVm.DebugInfoProvider.Breakpoints;
                ...
                case JumpToolCommand jumpCommand:
                    {
                        ...
                        address = SpectrumVm.Cpu.Registers.PC = resolvedAddress;
                        break;
                    }
        ...
        public override void RefreshOnPause()
        {
            DisassemblyViewRefreshed?.Invoke(this,
                new DisassemblyViewRefreshedEventArgs(SpectrumVm.Cpu.Registers.PC));
        }
        ...
        protected override void OnFirstStart()
        {
            base.OnFirstStart();
            DisassemblyViewRefreshed?.Invoke(this,
                new DisassemblyViewRefreshedEventArgs(EmulatorViewModel.DisAssViewPoint));
        }
        ...
        {
            var memoryDevice = SpectrumVm.MemoryDevice;
            var memoryConfig = SpectrumVm.MemoryConfiguration;
            ...
            var disassembler = new Z80Disassembler(map,
                memory,
                disassemblyFlags,
                SpectrumVm.Cpu.AllowExtendedInstructionSet);
            return disassembler;
        }
...
#pragma warning restore VSTHRD110 // Observe result of async calls
        ...
        private void AttachToTapeDeviceEvents()
        {
            ...
            SpectrumVm.TapeLoadDevice.LeftLoadMode += TapeDeviceOnLeftLoadMode;
        ...
        public bool HasBreakpoint(ushort address)
        {
            ...
            var breakpoints = EmulatorViewModel.DebugInfoProvider?.Breakpoints;
            if (breakpoints == null)
            {
                return false;
            }
        ...
        {
            return MachineState == VmState.Paused
                && SpectrumVm?.Cpu.Registers.PC == address;
        }
