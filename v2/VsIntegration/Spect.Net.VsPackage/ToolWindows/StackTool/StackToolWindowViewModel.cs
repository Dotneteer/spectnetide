...
namespace Spect.Net.VsPackage.ToolWindows.StackTool
{
    ...
    /// </summary>
    public class StackToolWindowViewModel : SpectrumToolWindowViewModelBase
    {
        ...
        /// <summary>
        /// Clears the stack manipulation events when solution is closing
        /// </summary>
        ...
        public void Refresh()
        {
            if (!(EmulatorViewModel?.StackDebugSupport is IStackEventData stackDebugSupport))
            {
                return;
            }
