...
{
    public partial class Z80TestParser
    {
        /// <summary>
        /// Syntax errors caught dureing the parsing phase
        /// </summary>
        public List<Z80TestParserErrorInfo> SyntaxErrors { get; } = new List<Z80TestParserErrorInfo>();
        ...
        private class Z80TestErrorListener : IAntlrErrorListener<IToken>
        {
            ...
            /// </summary>
            private Z80TestParser Parser { get; }

            /// <summary>Initializes a new instance of the <see cref="T:System.Object" /> class.</summary>
            public Z80TestErrorListener(Z80TestParser parser)
            {
                Parser = parser;
            }
            ...
            {
                Parser.SyntaxErrors.Add(new Z80TestParserErrorInfo
                {
                    SourceLine = line,
